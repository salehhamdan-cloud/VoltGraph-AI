...
export const ICON_PATHS: Record<string, string> = {
  ...
  ac_unit: "M22 11h-4.17l3.24-3.24-1.41-1.41L15.06 11h-4V7l4.66-4.66-1.41-1.41L11 4.17V0h-2v4.17L5.76.93 4.34 2.34 9 7v4H4.94l-4.66-4.66-1.42 1.41L3.24 11H0v2h4.17l-3.24 3.24 1.41 1.41L6.94 13h4v4l-4.66 4.66 1.41 1.41L11 19.83V24h2v-4.17l3.24 3.24 1.41-1.41L13 17v-4h4.06l4.66 4.66 1.41-1.41L18.76 13H22v-2z",
